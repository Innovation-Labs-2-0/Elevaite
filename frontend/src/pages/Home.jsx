    ...
    <div className="space-y-12">
      ...
      <div className="text-center">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-600">
          Sign in using your corporate account to submit ideas, collaborate, and
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="card">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-700">
            <li>
              <strong>Submit:</strong> Articulate a problem and solution.
            </li>
            <li>
              <strong>Discuss:</strong> Browse and upvote ideas.
            </li>
            <li>
              <strong>Review:</strong> Expert panel evaluates.
            </li>
            <li>
              <strong>Hackathon:</strong> Build your build.
            </li>
            <li>
              <strong>Win:</strong> Best ideas get recognized.
            </li>
          </ol>
        </div>
        ...
        <div className="card">
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              ...
              <div>
                <strong>Jan 8- Jan 31:</strong> Submissions Open
              </div>
            </li>
            <li className="flex items-start">
              ...
              <div>
                <strong>Feb 2 - Feb 17:</strong> Review Period
              </div>
            </li>
            <li className="flex items-start">
              <span className="bg-gray-200 rounded-full w-8 h-8 flex items-center justify-center mr-4">
              ...
              <div>
                <strong>Feb 21:</strong> Hackathon Starts{" "}
              </div>
            </li>
            <li className="flex items-start">
              <span className="bg-gray-200 rounded-full w-8 h-8 flex items-center justify-center mr-4">
              ...
              <div>
                <strong>March 10:</strong> Demo Day and Winners Announced{" "}
              </div>
            </li>
          </ul>
        </div>
